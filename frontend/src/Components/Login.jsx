...
export default function Login() {
  ...
  return (
    <>
      <Button className="border-b border-b-red-700  border-t border-t-red-700 border-r border-r-red-700 border-l border-l-red-700 bg-transparent hover:bg-red-700 text-white" onPress={onOpen}>
        Iniciar Sesion 
      </Button>
